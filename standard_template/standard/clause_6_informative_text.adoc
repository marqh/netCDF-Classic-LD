...
NetCDF dimension names are treated as internal references within the netCDF file.  The choice of names is not interpreted semantically within this standard and there is no provision for preserving the names 