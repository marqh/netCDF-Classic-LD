:Title: OGC Encoding Linked Data Graphs in NetCDF Classic Files
:titletext: OGC (add title text)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    19-002
|Version: n.n
|Category: OGC(R) Implementation
|Editor:   Mark Hedley, Jonathan Yu
|===
